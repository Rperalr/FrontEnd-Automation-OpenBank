...
public class MethodsXpath extends BasePage {
    ...
    public HomePageXPath Method_Hazte_Cliente() {
            HomePageXPath cliente = new HomePageXPath(driver);
                    actions.click(cliente.getBtn_HASTE_CLIENTE());
                    waits.timeOutImplicitWaitHorTwo(driver);
                    actions.click(cliente.getBtn_QUIERO_HACERME_CLIENTE());
        return cliente;
    }
    public HomePageCssLlenarForm Method_Llenado_Formulario_Hazte_Cliente() {
            HomePageCssLlenarForm form = new HomePageCssLlenarForm(driver);
                ...
                actions.sendKeys(form.txtbx_1ER_APELLIDO, "test");
                actions.sendKeys(form.txtbx_2DO_APELLIDO, "aseguramiento");
                actions.scrollDown(driver);
